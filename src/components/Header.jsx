                        ...
                        {isNotificationsOpen && (
                            ...
                            >
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded-full">{notificationCount} New</span>
                                </div>
                                ...
                                <div className="mt-3 pt-2 border-t border-gray-100">
                                    <a href="/notifications" className="text-blue-500 text-xs hover:underline block text-center">View all notifications</a>
                                </div>
                            </div>
                        )}
                    </div>
                        ...
                        {isUserProfileOpen && (
                            ...
                            >
                                <div className="flex flex-col space-y-3">
                                    ...
                                    {/* Menu Items */}
                                    <a href="/profile" className="flex items-center space-x-3 text-gray-700 hover:text-blue-500 transition-colors duration-200 group">
                                    ...
                                    <a href="/help" className="flex items-center space-x-3 text-gray-700 hover:text-blue-500 transition-colors duration-200 group">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
